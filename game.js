var sketchProc = function(processingInstance) {
 with (processingInstance) {
    ...
    var op3 = [" ●↑", color(191, 199, 76)];
    var op4 = [" ●↓", color(191, 199, 76)];
    var op5 = ["⇐⇒", color(238, 255, 0)];
    var op6 = ["⇒⇐", color(238, 255, 0)];
    var op7 = ["★", color(255, 82, 189)];
    var op8 = [" ●+", color(154, 159, 230)];
    ...
    mouseMoved = function() {
        if (currentScene === 'main') {
            ...
            bar.position.x = constrain(bar.position.x, bar.width/2, 400-bar.width/2);
